...
<html lang="en">
    ...
    <section>
        ...
        <form action=""class="add_product" method="post" enctype="multipart/form-data">
            <input type="text" name="product_name" placeholder="Enter the Products name"class="input_fields" required>
            <input type="number" name="product_price" min="0" placeholder="Enter the Products price"class="input_fields" required>
